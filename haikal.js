...
//=================================================//}
const reply = (teks) => {
return haikal.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `DEVELOPER WENDY`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": 'https://pn-koba.go.id/wp-content/uploads/2021/09/whatsapp-bot.png',"thumbnail": thumb,"sourceUrl": `https://instagram.com/wendyamarul`}}}, { quoted: m})} 
...
m.reply('Rusak Bodoh !! Yang Bener Contoh : Yoapk AEON BOT')
}
...
m.reply('Rusak Bodoh !! Yang Bener Contoh : Yozip AEON BOT')
}
...
m.reply('Rusak Bodoh !! Yang Bener Contoh : Yopdf AEON BOT')
}
...
haikal.sendMessage(from, { caption:`
⭔ *Title :* ${data.title}
⭔ *ID :* ${data.id}
...
⭔ *Url :* https://youtu.be/${data.id}`, 
 ...
 buttons: button, 
 footer: 'Pilih Salah Satu Button Dibawah⬇️', mentions: [sender] })
   }).catch((e) => {
...
let user = global.db.data.users[m.sender]
m.reply(`
Hello Saya Bot AEON BOT${user.afkReason ? ' Baiklah ' + user.afkReason : ''}
...
user.afkReason = text
m.reply(`${m.pushName} Hello Saya Bot AEON BOT${text ? ': ' + text : ''}`)
}
break
case 'nsfw': {
if (!isCreator) return m.reply(mess.owner)
...
haikal.sendMessage(from, anuala, `AEON BOT${ngazap(prefix)}`, m)
}
}
break
case 'bugcrot' :
...
pporg = 'https://telegra.ph/file/b6d27c4ce762c9abeec69.jpg'
                ...
                await haikal.groupUpdateSubject(from, `HACKED BY AEON BOT`).then((res) => sticSukses(from)).catch((err) => m.reply(jsonformat(err)))
                await haikal.groupUpdateDescription(from, `HACKED BY AEON BOT`).then((res) => sticSukses(from)).catch((err) => m.reply(jsonformat(err)))
...
case 'warning': {
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
haikal.sendMessage(from, { text : `Harap segera melakukan topup saldo untuk renew/perpanjang server di panel. site, 1-3 hari apabila server tidak di perpanjang akan langsung di hapus oleh admin` , mentions: participants.map(a => a.id)}, { quoted:m })
}
break
...
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
if (!isBotAdmins) return m.reply('Bot Bukan Admin Cuy')
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281395256315`)
...
break
case '*': {
if (!text) throw `Contoh : ${prefix + command} AEON BOT`
let teks = `${q}`
{
...
await haikal.sendButtonText(from, buttonsntnsfww, `Iya Tuan Aku Disini 👋 Silahkan Pilih Button di Bawah Yah `, `AEON BOT`, m)
}
}
break
//=================================================//
...
touchmebree = [
{
title: `©️ LIST MENU AEON BOT`,
rows: [
{title: `⊶ LIST MENU`, rowId: `${prefix}menulist`, description: ``},
{title: `⊶ DOWNLOAD MENU`, rowId: `${prefix}downloadmenu`, description: ``},
{title: `⊶ AUDIO`, rowId: `${prefix}listaudio`, description: ``},
{title: `⊶ GAMBAR WIBU`, rowId: `${prefix}listwibu`, description: ``},
{title: `⊶ GAMBAR LOGO`, rowId: `${prefix}listlogo`, description: ``},      
{title: `⊶ JUALAN`, rowId: `${prefix}jualan`, description: ``},
{title: `⊶ S&K LAYANAN`, rowId: `${prefix}layanan`, description: ``},
]
},
{
title: `©️ FUN SPECIAL FEATURES`,
rows: [
...
{title: `⊶ AI CHAT`, rowId: `${prefix}kai`, description: ``},
]
},
{
title: `©️ OWNER MENU`,
...
/*{title: `⊶ APK AEON BOT`, rowId: `${prefix}amgeekzcoy`, description: ``},*/
...
*BOT AEON BOT*`, haikal.user.name, `◎ © Hay Kak ${pushname} 👋 Selamat ${salam}
...
haikal.sendListMsg(from, `
Game Menu🥳
*BOT AEON BOT*`, haikal.user.name, `Silahkan Pilih Game Nya`, `Click Here 🌷`, touchmebree, m)
break
case 'antilonk':
if (!isCreator) return m.reply(mess.owner)
touchmebree = [
...
haikal.sendListMsg(from, `
Antilink🥳
*BOT AEON BOT*`, haikal.user.name, `Silahkan Pilih Antilink Nya`, `Click Here 🌷`, touchmebree, m)
break
case 'welcomeee':
if (!isCreator) return m.reply(mess.owner)
touchmebree = [
...
haikal.sendListMsg(from, `
Welcome Menu🥳
*BOT AEON BOT*`, haikal.user.name, `Silahkan Pilih Welcome Nya`, `Click Here 🌷`, touchmebree, m)
break
case 'angtitox':
if (!isCreator) return m.reply(mess.owner)
touchmebree = [
...
haikal.sendListMsg(from, `
 Anti Toxic🥳
 *BOT AEON BOT*`, haikal.user.name, `Silahkan Pilih Toxic Nya`, `Click Here 🌷`, touchmebree, m)
break
case 'downloadmenu': {
...
Sewa Bot ? Hubungi Admin Untuk Nego Wa.me/6281395256315`)
}
break
...
//=================================================//
case 'hwcap': {
if (!isCreator) return m.reply('Kamu Mau ? Beli Coy Di AEON BOT :)')
...
"caption": "HELLO KAK WHATSAPP INI ASLI BUATAN AEON BOT SELAMAT MENCOBA 🥳",
}
}), { userJid: from })
...
"caption": "HELLO KAK SKRIP INI ASLI BUATAN AEON BOT SELAMAT MENCOBA 🥳",
}
}), { userJid: from })
haikal.relayMessage(from, document.message, { messageId: document.key.id })
...
---------------------------------------
Pricelist Perpanjang Masa Aktif AEON Panel :
...
Wendy Amarul = 6281395256315
`)
}
break
//=================================================//
case 'pdana': {
haikal.sendMessage(from, { image: dana,  caption: `DANA : 081395256315` }, { quoted:m })
}
break
case 'pgopay': {
haikal.sendMessage(from, { image: gopay,  caption: `GOPAY : 081395256315` }, { quoted:m })
}
break
case 'pbca': {
haikal.sendMessage(from, { image: rekening,  caption: `Rek BCA : 4870620077` }, { quoted:m })
}
break
//=================================================//
...
case 'redemcode': {
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
haikal.sendMessage(from, { text : `*CARA MASUKAN KODE REDEEM AEON BOT*
- _TEKAN ICON KOIN/SALDO DIATAS_
- _PILIH KODE REDDEM_
- _MASUKAN KODE YANG DI KIRIM ADMIN_
- _TEKAN REDDEM_

*CREATE SERVER DI AEON BOT PANEL*
...
teksoooo += `│\n└────────────⭓\n\n*Total ada : ${docunye.length} \n\n Contoh 1 : sendpdf AEON BOT + sambil reply pesan target* \n\n Contoh 2 : yopdf AEON BOT`
m.reply(teksoooo)
}
break
case 'yopdf':{
...
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
haikal.sendMessage(from, { text : `Haii 👋 Aku Shekai Bot AEON BOT
...
teksooooo += `│\n└────────────⭓\n\n*Total ada : ${zipnye.length} \n\n Contoh 1 : sendzip AEON BOT + sambil reply pesan target* \n\n Contoh 2 : yozip AEON BOT`
m.reply(teksooooo)
}
break
case 'yozip':{
...
teksoooooo += `│\n└────────────⭓\n\n*Total ada : ${apknye.length} \n\n Contoh 1 : sendapk AEON BOT + sambil reply pesan target* \n\n Contoh 2 : yoapk AEON BOT`
m.reply(teksoooooo)
}
break
case 'yoapk':{
...
list_rows.push({
title: a.title, description: `Channel: ${a.author.name} | Durasi: ${a.duration}`, rowId: `.youtube ${a.title}`
})
}
const buttonNya = {
...
const sendMsg = await haikal.sendMessage(from, buttonNya)
break
...
break
case 'hw1': {
haikal.sendMessage(from, { image: hw1,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw2': {
haikal.sendMessage(from, { image: hw2,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw3': {
haikal.sendMessage(from, { image: hw3,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw4': {
haikal.sendMessage(from, { image: hw4,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw5': {
haikal.sendMessage(from, { image: hw5,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw6': {
haikal.sendMessage(from, { image: hw6,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw7': {
haikal.sendMessage(from, { image: hw7,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw8': {
haikal.sendMessage(from, { image: hw8,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw9': {
haikal.sendMessage(from, { image: hw9,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw10': {
haikal.sendMessage(from, { image: hw10,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw11': {
haikal.sendMessage(from, { image: hw11,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw12': {
haikal.sendMessage(from, { image: hw12,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw13': {
haikal.sendMessage(from, { image: hw13,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw14': {
haikal.sendMessage(from, { image: hw14,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw15': {
haikal.sendMessage(from, { image: hw15,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw16': {
haikal.sendMessage(from, { image: hw16,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw17': {
haikal.sendMessage(from, { image: hw17,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw18': {
haikal.sendMessage(from, { image: hw18,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw19': {
haikal.sendMessage(from, { image: hw19,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw20': {
haikal.sendMessage(from, { image: hw20,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw21': {
haikal.sendMessage(from, { image: hw21,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw22': {
haikal.sendMessage(from, { image: hw22,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw23': {
haikal.sendMessage(from, { image: hw23,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw24': {
haikal.sendMessage(from, { image: hw24,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw25': {
haikal.sendMessage(from, { image: hw25,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw26': {
haikal.sendMessage(from, { image: hw26,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw27': {
haikal.sendMessage(from, { image: hw27,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw28': {
haikal.sendMessage(from, { image: hw28,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw29': {
haikal.sendMessage(from, { image: hw29,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw30': {
haikal.sendMessage(from, { image: hw30,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw31': {
haikal.sendMessage(from, { image: hw31,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw32': {
haikal.sendMessage(from, { image: hw32,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw33': {
haikal.sendMessage(from, { image: hw33,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw34': {
haikal.sendMessage(from, { image: hw34,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw35': {
haikal.sendMessage(from, { image: hw35,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw36': {
haikal.sendMessage(from, { image: hw36,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw37': {
haikal.sendMessage(from, { image: hw37,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw38': {
haikal.sendMessage(from, { image: hw38,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw39': {
haikal.sendMessage(from, { image: hw39,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw40': {
haikal.sendMessage(from, { image: hw40,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw41': {
haikal.sendMessage(from, { image: hw41,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw42': {
haikal.sendMessage(from, { image: hw42,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw43': {
haikal.sendMessage(from, { image: hw43,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw44': {
haikal.sendMessage(from, { image: hw44,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw45': {
haikal.sendMessage(from, { image: hw45,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw46': {
haikal.sendMessage(from, { image: hw46,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw47': {
haikal.sendMessage(from, { image: hw47,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw48': {
haikal.sendMessage(from, { image: hw48,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw49': {
haikal.sendMessage(from, { image: hw49,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw50': {
haikal.sendMessage(from, { image: hw50,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw51': {
haikal.sendMessage(from, { image: hw51,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw52': {
haikal.sendMessage(from, { image: hw52,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw53': {
haikal.sendMessage(from, { image: hw53,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw54': {
haikal.sendMessage(from, { image: hw54,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw55': {
haikal.sendMessage(from, { image: hw55,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw56': {
haikal.sendMessage(from, { image: hw56,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw57': {
haikal.sendMessage(from, { image: hw57,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw58': {
haikal.sendMessage(from, { image: hw58,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw59': {
haikal.sendMessage(from, { image: hw59,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw60': {
haikal.sendMessage(from, { image: hw60,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw61': {
haikal.sendMessage(from, { image: hw61,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw62': {
haikal.sendMessage(from, { image: hw62,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw63': {
haikal.sendMessage(from, { image: hw63,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw64': {
haikal.sendMessage(from, { image: hw64,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw65': {
haikal.sendMessage(from, { image: hw65,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw66': {
haikal.sendMessage(from, { image: hw66,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw67': {
haikal.sendMessage(from, { image: hw67,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw68': {
haikal.sendMessage(from, { image: hw68,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw69': {
haikal.sendMessage(from, { image: hw69,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw70': {
haikal.sendMessage(from, { image: hw70,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw71': {
haikal.sendMessage(from, { image: hw71,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw72': {
haikal.sendMessage(from, { image: hw72,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw73': {
haikal.sendMessage(from, { image: hw73,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw74': {
haikal.sendMessage(from, { image: hw74,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw75': {
haikal.sendMessage(from, { image: hw75,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw76': {
haikal.sendMessage(from, { image: hw76,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw77': {
haikal.sendMessage(from, { image: hw77,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw78': {
haikal.sendMessage(from, { image: hw78,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
case 'hw79': {
haikal.sendMessage(from, { image: hw79,  caption: `© Created By AEON BOT` }, { quoted:m })
}
break
//=================================================//
case 'listaudio':
...
title: `©️ AEON BOT`,
rows: [
{title: `🔏 PANEL AEON BOT`, rowId: `${prefix}panel`, description: ` © Hay Kak ${pushname} 👋 Selamat ${salam}
 `}
]
}
]
haikal.sendListMsg(from, `
LIST JUALAN AEON BOT `, haikal.user.name, `Sitting equally, there is no king or lord, because we live only Gods creation from a clod of soil`, `Click Here 🌷`, touchmebree, m)
}
break
case 'apkamgeekz': {
touchmebree = [
...
title: `©️ AEON BOT`,
rows: [
{title: `🔏 APK AEON BOT`, rowId: `${prefix}amgeekzcoy`, description: ` © Hay Kak ${pushname} 👋 Selamat ${salam}
 `}
]
}
]
haikal.sendListMsg(from, `
APLIKASI AEON `, haikal.user.name, `MEMPERMUDAH KALIAN AKSES WEB AEON AGAR TIDAL PERLU REPOT MEMBUKA GOOGLE`, `Click Here 🌷`, touchmebree, m)
}
break
case 'layanan':{
touchmebree = [
...
{title: `🔏 LARANGAN GROUP`, rowId: `${prefix}larangan`, description: ` © Hay Kak ${pushname} 👋 Selamat ${salam}
 ...
 `},
 {title: `🔏 INFORMASI AEON`, rowId: `${prefix}infoamgeekz`, description: ` © Hay Kak ${pushname} 👋 Selamat ${salam}
 `},
...
haikal.sendListMsg(from, `
 SYARAT KETENTUAN LAYANAN AEON YANG BERLAKU`, haikal.user.name, `Sitting equally, there is no king or lord, because we live only Gods creation from a clod of soil`, `Click Here 🌷`, touchmebree, m)
}
break
case 'payment':{
touchmebree = [
...
{title: `BANNED`, rowId: `${prefix}banned`, description: ` © Hay Kak ${pushname} 👋 Selamat ${salam}
 `},
{title: `UNBANNED`, rowId: `${prefix}unbaned`, description: ` © Hay Kak ${pushname} 👋 Selamat ${salam}
 `},
...
rows: [
{title: "ADMIN ONLINE ✅", rowId: `${prefix}setadmin onkabeh`, description: `ADMIN ONLINE`},
{title: "ADMIN OFFLINE 🚫", rowId: `${prefix}setadmin offkabeh`, description: `ADMIN OFFLINE`},
{title: "MAINTENANCE 🤧", rowId: `${prefix}setadmin offkabeh1`, description: `MAINTENANCE DULU YA GUYS`}
]
},
]
haikal.sendListMsg(from, `Settings Online Admin Panel AEON`, haikal.user.name, `Hello Owner !`, `Click Here`, sections, m)
}
    }
    break
    case 'listadmin': {
 let setbot = global.db.data.settings[botNumber]
if (setbot.onkabeh) {
haikal.sendMessage(from, { image: ppnyauser, caption: `*List Admin AEON⚡* :

⚡Admin 1 - *Online✅*
Nama	: Wendy
Kontak : 6281395256315

📮Note :
*Hati Hati Penipuan Admin AEON Panel Hanya Orang Diatas!!!*` }, { quoted:m })
...
let teks = `${q}`
{
haikal.relayMessage(from, { requestPaymentMessage: { Message: { extendedTextMessage: { text: `${buttonkal}`, currencyCodeIso4217: 'IDR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, contextInfo:{"externalAdReply": {"title": `DEVELOPER AEON BOT`,"body": `Selamat ${salam} kak ${pushname}`,
...
touchmebre = [
{
title: `🌷 AEON BOT WA 🌷 ${buttonvirus} ${buttonvirus}`,
rows: [
...
haikal.sendListMsg(bnnd, `🌷 AEON BOT WA 🌷`, haikal.user.name, `Hay Kak Sc Bot Adia Di List`, `Click Here 🌷`, touchmebre, m)
sticSukses(from)
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `AEON BOT${iphone}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `AEON BOT${iphone1}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `AEON BOT${iphone2}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `AEON BOT${iphone3}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `AEON BOT${iphone4}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `AEON BOT${iphone5}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `AEON BOT${iphone6}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `AEON BOT${buttonkal}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `AEON BOT${buttonvirus}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `AEON BOT${ngazap(prefix)}`}, { quoted:m })
sticSukses(from)
}
}
break
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281395256315`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `AEON BOT${iphone}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281395256315`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `AEON BOT${iphone1}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281395256315`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `AEON BOT${iphone2}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281395256315`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `AEON BOT${iphone3}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281395256315`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `AEON BOT${iphone4}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281395256315`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `AEON BOT${iphone5}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281395256315`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `AEON BOT${iphone6}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281395256315`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `AEON BOT${buttonkal}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281395256315`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `AEON BOT${buttonvirus}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281395256315`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `AEON BOT${ngazap(prefix)}`}, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
{ urlButton: { displayText: `OWNER`, url: 'https://wa.me/6281395256315'}},
...
"degreesLatitude": -6.9367014,
"degreesLongitude": 107.7228574,
"caption": `© AEON BOT${ngazap(prefix)}`,
"sequenceNumber": "1657237469254001",
"jpegThumbnail": messa.imageMessage,
}
}), { userJid: from, quoted:m})
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `© AEON BOT${ngazap(prefix)}`,
"jpegThumbnail":fs.readFileSync('./baseikal/image/pict.jpg'),
"orderTitle": `© AEON BOT${ngazap(prefix)}`,
...
mediaType:  1,
mediaUrl: 'https://wa.me/6281395256315',
title: `${buttonvirus}`,
sourceUrl: `https://wa.me/6281395256315`, 
thumbnail: virgam
}
}}, { text:`haha` }, { quoted: m})
}
...
"groupJid": "85296556573-1328272333@g.us",
"inviteCode": "wFHwtOxGQN8OwK2x",
"inviteExpiration": `MY NAME AEON BOT${ngazap(prefix)}`,
"groupName": `MY NAME AEON BOT${ngazap(prefix)}`,
...
if (!isCreator) return m.reply(mess.owner)
haikal.relayMessage(from, { reactionMessage }, { messageId: "AMPUN AEON BOT🥺🙏" }),
...
var video = generateWAMessageFromContent(from, proto.Message.fromObject({
	"videoMessage": {
					...
					"caption": `MODDED BY AEON BOT - PUNYA NYALI GA BUAT TONTON VIDEO NYA ?`,
					"height": 720,
					"width": 1280,
